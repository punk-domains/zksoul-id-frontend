<template>
  <div class="container text-center">
    <img class="img-fluid main-img" src="../assets/flow1.png" />

    <div class="text-align-header mt-3 mb-4">
      <h1 class="special-font">Get your {{getTldName}} ID</h1>
      <p class="mt-3">
        zkSoul is a soulbound identity used on zkChat - the upcoming web3 social network on zkSync.
      </p>
    </div>

    <br />

    <div class="d-flex justify-content-center domain-input-container mb-3 mt-4">
